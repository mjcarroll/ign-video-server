...
#include "ignition/async_web_server_cpp/websocket_request_handler.hh"
#include "ignition/async_web_server_cpp/websocket_connection.hh"
#include "ignition/async_web_server_cpp/http_reply.hh"

static constexpr const char* KEY_MAGIC_STRING  = "258EAFA5-E914-47DA-95CA-C5AB0DC85B11";
...
bool WebsocketHttpRequestHandler::operator()(const HttpRequest &request, HttpConnectionPtr connection, const char* begin, const char* end)
{
