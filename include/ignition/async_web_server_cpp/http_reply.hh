#ifndef IGNITION__ASYNC_WEB_SERVER_CPP__HTTP_REPLY_HH_
#define IGNITION__ASYNC_WEB_SERVER_CPP__HTTP_REPLY_HH_
...
public:
  ...
  bool operator()(const HttpRequest &, HttpConnectionPtr, const char* begin, const char* end);
...
#endif  // IGNITION__ASYNC_WEB_SERVER_CPP__HTTP_REPLY_HH_
